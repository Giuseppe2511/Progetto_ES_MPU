...
static portSTACK_TYPE xTaskStack1[ 128 ] __attribute__((aligned(128*4)));
static portSTACK_TYPE xTaskStack2[ 128 ] __attribute__((aligned(128*4)));
...
//  xTaskCreate(StartDefaultTask, "Task1", 128, (void *)0, 24, NULL);
//  xTaskCreate(StartDefaultTask, "Task2", 128, (void *)1, 24, NULL);
  xTaskCreateRestricted(&xTaskDefinition1, NULL);
  xTaskCreateRestricted(&xTaskDefinition2, NULL);
